...
var UIController = (function () {
    ...
    var formatNumber = function (num, type) {
        ...
        /*
          ...
          comma separating the thoussands
        */
        num = Math.abs(num);
        num = num.toFixed(2);
    ...
    return {
        ...
        displayPercentages: function (percentages) {
            var fields = document.querySelectorAll(DOMstrings.epensesPercLabel);
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var updateBudget = function () {
        ...
        // 63 Display the budget on the UI
    ...
    var updatePercentages = function () {
        ...
        // 3. Update the US with the new percentages
    ...
    var ctrlDeleteItem = function (event) {
        ...
        if (itemID) {
            ...
            // 1. Ddelele the item from the data structure
